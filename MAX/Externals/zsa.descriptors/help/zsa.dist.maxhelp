...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 87.5, 513.0, 171.0, 39.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 76.0, 371.0, 554.0, 33.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 160.0, 692.0, 65.0, 19.0 ]
								}
...
,
									"patching_rect" : [ 160.0, 632.0, 65.0, 19.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"default_fontsize" : 11.595187,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 23.0, 6.0, 588.0, 47.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 574.0, 281.0, 50.0, 19.0 ]
								}
...
,
									"patching_rect" : [ 574.0, 253.0, 65.0, 19.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"default_fontsize" : 11.595187,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 409.0, 271.0, 132.0, 33.0 ],
									"text" : "zsa.dist @append 1 @quiet 1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 209.0, 281.0, 50.0, 19.0 ]
								}
...
,
									"patching_rect" : [ 209.0, 253.0, 65.0, 19.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"default_fontsize" : 11.595187,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 243.0, 420.0, 186.0, 24.0 ],
									"text" : "smaller value == better match"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 56.0, 331.0, 160.0, 33.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 253.0, 418.0, 186.0, 24.0 ],
									"text" : "smaller value == better match"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 56.0, 326.0, 181.0, 33.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 243.5, 411.0, 186.0, 24.0 ],
									"text" : "higher value == better match"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 56.0, 326.0, 162.0, 33.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 232.0, 411.0, 186.0, 24.0 ],
									"text" : "higher value == better match"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 56.0, 326.0, 139.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 539.0, 507.0, 141.0, 51.0 ],
					"varname" : "zsa_seealso",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "zsa.seealso.maxpat",
				"bootpath" : "/Users/ej/Perso-works/spectral_stuff/zsa_repos/gitzsa/misc",
...
, 			{
				"name" : "zsa.utils.js",
				"bootpath" : "/Users/ej/Perso-works/spectral_stuff/zsa_repos/gitzsa/javascript",
